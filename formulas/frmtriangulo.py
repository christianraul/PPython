...
txtlado=Entry(raiz, font=("Arial", 12))
txtlado.place(x=160, y=65)
btnmostrar =Button(raiz, text="Calcular", bg=colorboton, command=calcular, font=("Ebrima", 14), anchor="center", activebackground="red").place(x=70, y=100)
btncerrar =Button(raiz, text="Cerrar", bg="red", command=raiz.quit, font=("Ebrima", 14), anchor="center", activebackground="yellow").place(x=170, y=100)
lbltitulo=Label(raiz, text="El resultado es: ", bg=colorfondo, font=("Ebrima", 20)).place(x=10, y=150)
lblresultado= Label(raiz, textvariable=areatri, bg=colorfondo, font=("Ebrima", 20))
